...
function render() {
    ...
    var projectionViewMatrix = perspective(90.0, canvas.width/canvas.height, 0.01, 10);
...
function buttons() {
  ...
  document.getElementById("minification").addEventListener("change", function(event) {
      switch (event.target.value) {
          case "nearest":
              gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MIN_FILTER, gl.NEAREST);
              break;
  ...
  document.getElementById("magnification").addEventListener("change", function(event) {
      switch (event.target.value) {
          case "nearest":
              gl.texParameteri(gl.TEXTURE_2D, gl.TEXTURE_MAG_FILTER, gl.NEAREST);
              break;
